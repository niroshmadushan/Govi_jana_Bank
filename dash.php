...
if($normalbalance<0){
    $normalbalance=round(($normalbalance*-1),2);
...
if($normalbalance<0){
    $sharebalance=round(($sharebalance*-1),2);
    $sharebalance="($sharebalance)";
}
$totalsnbalance=$nbalance+$sbalance;
$ttlsnbalance=$totalsnbalance;
if($normalbalance<0){
    $totalsnbalance=round(($totalsnbalance*-1),2);
    $totalsnbalance="($totalsnbalance)";
}
                    ...
                    <input type="text" name="typ" value="<?php  echo $typ; ?>" hidden/>
                       <table>
                        ...
                        <tr>
                            ...
                            <td>
                            <input type="date" id="myDat" required  class="int" name="dte" min="<?php $todayDate = date('Y'); echo"$todayDate-01-01"?>" max="<?php $todayDate = date('Y'); echo"$todayDate-12-31"?>" value=<?php echo $dte;?>  >
                            </td>
                        </tr>
                        <tr>
                            <td>
                       ...
                       <?php }?>
                        ...
                        <div class="info">
                            <center>
                               ...
                               <span class="add"><?php echo$add; ?><?php echo"$regw" ?></span><br/>
