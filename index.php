    ...
    <body>
        ...
        <div class="sbln" id="sbl">
            ...
            <div class="infobar">
                ...
                <div class="wiop3">
                    <button class="sbtn" value="search" name="search">Log Out</button><br>
                ...
                <form action="login.php" method="post">
                    <table>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="password" name="password" id='usn' required/>
                            </td>
                        </tr>
                       
                    </table>
                    <input value="submit" type="submit" class="sbtn ok"/>
